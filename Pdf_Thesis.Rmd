...
# trying to fix precision of cost estimates
primary_data <- primary_data %>% 
...
The data available on HealthCost allow me to construct a data set containing the estimated price for each procedure and each provider-insurer combination for which data was available. I also keep values for "Typical Patient Complexity" and "Precision of the Cost Estimate" to use as controls in my analysis. 
