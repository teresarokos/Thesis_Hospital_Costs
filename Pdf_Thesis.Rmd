...
lm_hospitals1 <- lm(data = primary_regression_data,
                   formula = percent_medicare ~ n_hosp_hsa_total + typical_patient_complexity + `Hospital Quality` + 
...
lm_hospitals2 <- lm(data = primary_regression_data,
                   formula = percent_medicare ~ n_hosp_hrr_total + typical_patient_complexity + `Hospital Quality` + 
                     median_household_income + percent_pop_over65 + pop_density +
                     Anthem_NH + Harvard_Pilgrim_HC + CIGNA + factor(procedure))
...
lm_hospitals3 <- lm(data = primary_regression_data,
                   formula = percent_medicare ~ n_hosp_hsa_procedure + typical_patient_complexity + `Hospital Quality` + 
                     median_household_income + percent_pop_over65 + pop_density +
                     Anthem_NH + Harvard_Pilgrim_HC + CIGNA + factor(procedure))
...
lm_hospitals4 <- lm(data = primary_regression_data,
                   formula = percent_medicare ~ n_hosp_hrr_procedure + typical_patient_complexity + `Hospital Quality` + 
                     median_household_income + percent_pop_over65 + pop_density +
                     Anthem_NH + Harvard_Pilgrim_HC + CIGNA + factor(procedure))
...
lm_hospitals5 <- lm(data = primary_regression_data,
                   formula = percent_medicare ~ n_hosp_5mi_total + typical_patient_complexity + `Hospital Quality` + 
                     median_household_income + percent_pop_over65 + pop_density +
                     Anthem_NH + Harvard_Pilgrim_HC + CIGNA + factor(procedure))
...
lm_hospitals6 <- lm(data = primary_regression_data,
                   formula = percent_medicare ~ n_hosp_10mi_total + typical_patient_complexity + `Hospital Quality` + 
                     median_household_income + percent_pop_over65 + pop_density +
                     Anthem_NH + Harvard_Pilgrim_HC + CIGNA + factor(procedure))
...
lm_hospitals7 <- lm(data = primary_regression_data,
                   formula = percent_medicare ~ n_hosp_25mi_total  + typical_patient_complexity + `Hospital Quality` + 
                     median_household_income + percent_pop_over65 + pop_density +
                     Anthem_NH + Harvard_Pilgrim_HC + CIGNA + factor(procedure))
...
lm_hospitals8 <- lm(data = primary_regression_data,
                   formula = percent_medicare ~ n_hosp_5mi_procedure + typical_patient_complexity + `Hospital Quality` + 
                     median_household_income + percent_pop_over65 + pop_density +
                     Anthem_NH + Harvard_Pilgrim_HC + CIGNA + factor(procedure))
...
lm_hospitals9 <- lm(data = primary_regression_data,
                   formula = percent_medicare ~ n_hosp_10mi_procedure + typical_patient_complexity + `Hospital Quality` + 
                     median_household_income + percent_pop_over65 + pop_density +
                     Anthem_NH + Harvard_Pilgrim_HC + CIGNA + factor(procedure))
...
lm_hospitals10 <- lm(data = primary_regression_data,
                   formula = percent_medicare ~ n_hosp_25mi_procedure  + typical_patient_complexity + `Hospital Quality` + 
                     median_household_income + percent_pop_over65 + pop_density +
                     Anthem_NH + Harvard_Pilgrim_HC + CIGNA + factor(procedure))
...
stargazer(lm_hospitals1, lm_hospitals2, omit = c(10:170), header = FALSE, 
          ...
          covariate.labels = c("Total Number in HSA",
                               ...
                               "Hospital Quality",
                               "Median Income (county, in 1000s)",
                               "Percent Population 65 and older (county)",
                               "Population Density (county)"), 
          dep.var.labels = "Percent of Medicare Price")

stargazer(lm_hospitals5, lm_hospitals7, omit = c(10:170), header = FALSE,   
...
```{r, echo=FALSE, results = "asis", message=FALSE}
stargazer(lm_hospitals3, lm_hospitals4, omit = c(10:170), header = FALSE, 
...
stargazer(lm_hospitals8, lm_hospitals10, omit = c(10:170), header = FALSE,   
