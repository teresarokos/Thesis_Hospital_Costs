...
stargazer(felm_insurers1, felm_insurers2, felm_insurers3, felm_market_share, header = FALSE,
          ...
          # covariate.labels = c("Harvard Pilgrim", "CIGNA", "Commercial Market Share", "Constant (Anthem)"), 
          # dep.var.labels = "Percent of Medicare Price", font.size = "footnotesize", table.layout = "=ld#c-t-a-s-n")
```
...
stargazer(felm_hospitals1, felm_hospitals5, felm_hospitals2, felm_hospitals6, header = FALSE,
          ...
          #                      "Total Hospitals in 15-mile radius",
...
stargazer(felm_hospitals3, felm_hospitals7, felm_hospitals4, felm_hospitals8,
          ...
          #                      "Hospitals in 15-mile radius w/ procedure",
