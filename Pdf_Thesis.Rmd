...
stargazer(lm_insurers, omit = c(4:172), 
...
stargazer(lm_hospitals4, lm_hospitals5, lm_hospitals6, lm_hospitals7, omit = c(11:170),  
          title = "Number of Hospitals in Market (HSA/HRR definition) and Relative Price",
          covariate.labels = c("Total Number in HSA",
                               "Total Number in HRR",
                               "Number in HSA offering procedure",
                               ...
                               "Overall Hospital Rating - NA",
                               "Median Household Income (county)",
                               "% Population 65 and older (county)",
                               "Population Density (county)"), 
          dep.var.labels = "Percent of Medicare Price")

stargazer(lm_hospitals1, lm_hospitals2, lm_hospitals3, omit = c(11:170),  
          title = "Number of Hospitals in Market (radial definition) and Relative Price",
