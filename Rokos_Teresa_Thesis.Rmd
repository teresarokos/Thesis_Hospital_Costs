...
*[ACTUALLY TYPE UP LIT REVIEW] This paper builds on a significant literature that has also examined price variation across private payers and hospitals. Highlight Cooper et al. 2019; Ho and Lee 2017; Gaynor, Ho, Town 2015; Bai and Anderson 2018; and Dafny 2019 ... hospital merger/competition literature: Gaynor and Vogt 2003; Gowrisankaran, Nevo, Town 2015; Dafny, Ho, Lee 2016; Dafny 2009; Lewis and Pflum 2017; Vogt and Town 2009 ... Dranove, Capps, Ody 2018 ... insurer merger/competition literature: Dafny, Duggan, Ramanarayanan 2012; Dafny, Gruber, Ody 2015 ... across different insurer types: Cutler, McClellan, Newhouse 2000 in addition to Dafny 2019 ... my addition: further evidence of hospital and insurer market power affecting prices, but that market share does not explain full relationship and that insurer characteristics may also play a major role; examination of outpatient services with plausibly homogenous quality across hospitals*
...
In an additional specification of Equation (4), I add an interaction between the number of additional hospitals in hospital $h$'s market and an indicator for each insurer to allow for heterogenous relationships to hospital density. That is, one insurer may be more sensitive to the number of hospitals present in hospital $h$'s market because of their relative bargaining leverage in the price negotiation process. This bargaining leverage may be function of their own market share or something else. In order to test whether potential heterogeneity in insurer and hospital competition relationships are associated with the insurer's statewide market share, I also estimate the following equation:
\begin{equation}
y_{ijh} = \theta s_i + \delta_j + \zeta n_h + \kappa (n_h * s_i) + \beta_1p_{jh} + \beta_2q_h + \beta_3 X_{c(h)} + \varepsilon_{ijh}
\end{equation}
where the insurer dummies in Equation (5) have been replaced with statewide market share to result in an interaction between hospital density and insurer market share $(n_h * s_i)$. The significance of $\hat \kappa$ will test whether the negative effect on prices from hospital density is greater for insurers with greater market share.
...
stargazer(lm_hospitals1, lm_hospitals5, lm_hospitals2, lm_hospitals6,
          ...
          covariate.labels = c("HSA Hospital Density",
                               ...
                               "CIGNA",
                               "Constant (Anthem)"),
          dep.var.caption = "\\it{Dependent variable:} \\rm{Percent of Medicare Price}", font.size = "tiny", table.layout = "=ldc#-t-a-s-n")
