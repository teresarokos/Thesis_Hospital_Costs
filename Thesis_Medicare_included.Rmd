...
felm_hospitals_insurers_3 <- felm(data = primary_regression_data,
                                  formula = percent_medicare ~ n_hosp_15mi_p*Anthem_NH + n_hosp_15mi_p*Harvard_Pilgrim_HC + n_hosp_15mi_p*CIGNA + 
                                    typical_patient_complexity_scale + `Hospital Quality` + median_household_income + percent_pop_over65 + pop_density 
                                    | factor(procedure) | 0 | procedure)
...
felm_hospitals_insurers_5 <- felm(data = primary_regression_data,
                                  formula = percent_medicare ~ n_hosp_hsa_total*Anthem_NH + n_hosp_hsa_total*Harvard_Pilgrim_HC + n_hosp_hsa_total*CIGNA + 
                                    typical_patient_complexity_scale + `Hospital Quality` + median_household_income + percent_pop_over65 + pop_density 
                                  | factor(procedure) | 0 | procedure)

felm_hospitals_insurers_6 <- felm(data = primary_regression_data,
                                  formula = percent_medicare ~n_hosp_hrr_total*Anthem_NH +  n_hosp_hrr_total*Harvard_Pilgrim_HC + n_hosp_hrr_total*CIGNA + 
                                    typical_patient_complexity_scale + `Hospital Quality` + median_household_income + percent_pop_over65 + pop_density 
                                  | factor(procedure) | 0 | procedure)
...
felm_providers_3 <- felm(data = subset(primary_data, !insurer %in% c("Uninsured", "Other") & 
                                         !cpt_code %in% c("29826", "42820", "43239", "45378", "99282", "99283") &
                                         precision_of_cost_estimate != "low" & locality == "NEW HAMPSHIRE"),
